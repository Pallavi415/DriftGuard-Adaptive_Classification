...
The most useful comparison is between each model and its own adaptive version.

## Gaussian NB

| Metric | Non-Adaptive | Adaptive | Improvement |
|---|---:|---:|---:|
| Accuracy | 0.7141 | **0.7162** | +0.0021 |
| F1-score | 0.5116 | **0.5161** | +0.0045 |
| Recall | 0.4533 | **0.4595** | +0.0062 |

Gaussian NB showed the more noticeable benefit from explicit adaptation.
...
The improvement for KNN was very small.

This makes sense within the experiment because Windowed KNN already has a natural forgetting mechanism. Older observations leave the window as new observations arrive.

Gaussian NB maintains cumulative statistics, so explicit decay has more opportunity to change how historical information affects the model.

### Main finding

> **The value of adaptation depends on how the underlying model already handles historical information.**

Under the selected experimental configuration, adaptation improved both models, but the effect was more noticeable for Gaussian NB.
